...
Sub Main()
  ...
  PrintLn "Welcome to Excel-REST v4.0.0-beta.2, let's get started!"
...
Sub Execute()
  ...
  If AlreadyInstalled(Workbook) Then
    ...
    Message = Message & "- upgrade - Upgrade to Excel-REST v4.0.0-beta.2" & vbNewLine
  Else
    Message = Message & "- install - Install Excel-REST v4.0.0-beta.2" & vbNewLine
  End If
  ...
  Case "UPGRADE"
    ...
    ShouldUpgrade = Input(vbNewLine & _
      ...
      "Would you like to upgrade to v4.0.0-beta.2? [yes/no] <")
